...
### Proporciones mínimas, máximas y normales teóricas
...
Para la proporción mínima de "Danceability", se observaron las siguientes características en las canciones:
- Media: 0.5
